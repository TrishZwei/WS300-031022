...
//if we want we can redirect it to the page in which the data was submitted from and pass it a $_GET or $_POST variable to have it show a success or fail message on the original page. non-self parsing, non-self displaying pages are harder to troubleshoot.
